          ...
          <div className="max-w-7xl mx-auto px-6 w-full py-16 lg:py-24">
            <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
              ...
              <div className="reveal d3">
                ...
                {/* WhatsApp badge below card — terra-aligned, no green branding */}
                <div className="flex items-center gap-3 mt-4 px-5 py-3.5 rounded-xl"
                  ...
                  <div className="w-9 h-9 rounded-lg flex items-center justify-center shrink-0" style={{ background: 'var(--terra)' }}>
