    ...
    >
      ...
      <div className="p-5 flex flex-col flex-1">
        ...
        <h3
          ...
          style={{ fontFamily: 'var(--font-display)', fontWeight: 700, fontSize: '1.0625rem', color: 'var(--ink)', marginBottom: '.5rem', lineHeight: 1.25 }}
        >
          {p.titulo}
        </h3>
        ...
        <p style={{ fontFamily: 'var(--font-body)', fontSize: '.875rem', color: 'var(--text-secondary)', lineHeight: 1.6, flex: 1, marginBottom: '1rem' }}>
          {p.descripcion}
        </p>
    ...
    <section style={{ background: 'var(--ink)', padding: '6rem 0' }}>
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-14">
          <div>
            <p className="section-eyebrow mb-4" style={{ color: 'rgba(255,255,255,.35)' }}>
          ...
          <div className="flex flex-col items-start md:items-end gap-4">
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '1rem', color: 'rgba(255,255,255,.45)', maxWidth: '22rem', textAlign: 'right' }}>
        ...
        >
          <div>
            ...
            <p style={{ fontFamily: 'var(--font-body)', fontSize: '.9375rem', color: 'rgba(255,255,255,.5)', marginTop: '.25rem' }}>
