  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-6 h-16 md:h-20 flex items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              style={{ background: '#25D366', color: '#fff', fontFamily: 'var(--font-body)' }}
            >
      ...
      <a href={`${BRAND.whatsappLink}?text=Hola!%20Quiero%20saber%20más%20sobre%20Erasmus%20Life%20Valencia`}
        target="_blank" rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full flex items-center justify-center shadow-xl hover:scale-110 transition-transform duration-200 cursor-pointer"
