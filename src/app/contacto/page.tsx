        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-5 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              {/* WhatsApp CTA — ink base, sin verde (verde reservado para FAB global) */}
              <a href={`https://wa.me/${BRAND.whatsapp.replace(/\D/g, '')}?text=Hola%2C%20necesito%20ayuda`}
                target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-4 p-5 rounded-2xl transition-all hover:-translate-y-px"
                style={{ background: 'var(--ink)', color: '#fff', textDecoration: 'none', display: 'flex' }}>
